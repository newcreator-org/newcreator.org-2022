      ...
      <main>
        ...
        <article className="container mx-auto px-5 py-16 max-w-2xl legal-body">
          ...
          <section className="mb-10">
            <h2 className="legal-h2">第1条　個人情報の定義</h2>
            <p className="legal-p">
          ...
          <section className="mb-10">
            <h2 className="legal-h2">第2条　個人情報の収集方法</h2>
            <p className="legal-p">
          ...
          <section className="mb-10">
            <h2 className="legal-h2">第3条　個人情報の収集・利用目的</h2>
          ...
          <section className="mb-10">
            <h2 className="legal-h2">第4条　未成年の利用者の個人情報</h2>
            <p className="legal-p">
          ...
          <section className="mb-10">
            <h2 className="legal-h2">第5条　個人情報の第三者提供</h2>
          ...
          <section className="mb-10">
            <h2 className="legal-h2">第6条　個人情報の開示、修正および削除</h2>
            <p className="legal-p">
          ...
          <section className="mb-10">
            <h2 className="legal-h2">第8条　個人情報に関する問い合わせ先</h2>
            <p className="legal-p">
